            ...
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="85">
              ...
              <FormItem label="Orch域名" prop="orch_ip">
                <Input
                  ...
                  :maxlength="45"
                  placeholder="输入Orch IP"
                ></Input>
              </FormItem>

              <FormItem label="Orch ID" prop="orch_id">
                <Input
                  v-model="formValidate.orch_id"
                  :maxlength="45"
                  placeholder="输入Orch ID"
                ></Input>
              </FormItem>

              <FormItem label="POP ID" prop="pop_id">
                <Input
                  v-model="formValidate.pop_id"
                  :maxlength="45"
                  placeholder="输入POP ID"
                ></Input>
              </FormItem>

              <FormItem label="公网带宽" prop="bandwidth">
                <Input
                  v-model="formValidate.bandwidth"
                  :maxlength="45"
                  placeholder="输入公网带宽"
                ></Input>
              </FormItem>

              <FormItem label="项目" prop="project_name">
                <Input
              ...
              <FormItem label="负责人" prop="owner_name">
                <Input
              ...
              <FormItem label="是否注册jump" prop="jump_id">
                <Input
                  v-model="formValidate.jump_id"
                  :maxlength="45"
                  placeholder="输入是否注册jumpserver，是/否"
                ></Input>
              </FormItem>
          ...
          <Select v-model="formValidate.idc" placeholder="选择IDC机房">
            ...
            <Option value="其他" >其他</Option>
              ...
              <FormItem label="管理用户" prop="admin_user">
                <Select v-model="formValidate.admin_user" placeholder="请选择一个管理用户，登陆虚拟机，如：root" filterable>
